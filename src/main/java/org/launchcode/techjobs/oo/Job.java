...
public class Job {
    ...
    public String toString(){
       ...
       // String printedString = String.format("\nID: %x\nName: %s\nEmployer: %s\nLocation: %s\nPosition Type: %s\nCore Competency: %s\n", id, this.getName(), this.getEmployer(), this.getLocation(), this.getPositionType(), this.getCoreCompetency());
        ...
        return String.format("\nID: %x\nName: %s\nEmployer: %s\nLocation: %s\nPosition Type: %s\nCore Competency: %s\n", this.id, this.getName(), this.getEmployer(), this.getLocation(), this.getPositionType(), this.getCoreCompetency());
